...
class ServerError extends Error {
  constructor(message, statusCode = 500, originalError) {
    const msg = message + (originalError && originalError.message ? originalError.message : '');
    super(msg);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ServerError;
...
const VueServerRenderer = __webpack_require__(46);
...
class ViewRenderer {
  constructor(app, options) {
    ...
    Object.defineProperty(this, "clientManifest", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: void 0
    ...
    if (options.devMode !== true) {
      ...
      const devServer = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ViewRenderer;
...
/* WEBPACK VAR INJECTION */(function(__dirname) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_models_server__ = __webpack_require__(42);
const bluebird = __webpack_require__(11);


global.Promise = bluebird;

const server = new __WEBPACK_IMPORTED_MODULE_0__src_models_server__["a" /* default */]();

const koaStatic = __webpack_require__(52);
const path = __webpack_require__(8);
...
var PromiseArray =
    __webpack_require__(17)(Promise, INTERNAL,
...
var PassThroughHandlerContext =
    __webpack_require__(20)(Promise, tryConvertToPromise, NEXT_FILTER);
var catchFilter = __webpack_require__(4)(NEXT_FILTER);
var nodebackForPromise = __webpack_require__(5);
var errorObj = util.errorObj;
var tryCatch = util.tryCatch;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_koa__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_koa___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_koa__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__server_error__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_renderer__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__routes__ = __webpack_require__(48);
const Raven = __webpack_require__(43);

const pino = __webpack_require__(44);
...
class Server {
  constructor(options) {
    Object.defineProperty(this, "_isProductionMode", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: void 0
    ...
    Object.defineProperty(this, "_raven", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: void 0
    });
    Object.defineProperty(this, "_viewRenderer", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: void 0
  ...
  start() {
    this._instance = this._app.listen(this._port.toString(), () => {
      ...
      this._logger.info(`NODE_ENV: ${process.env.NODE_ENV ? process.env.NODE_ENV : 'empty NODE_ENV'}`);
  ...
  _initViewRenderer(options) {
    try {
      this._viewRenderer = new __WEBPACK_IMPORTED_MODULE_2__view_renderer__["a" /* default */](this._app, options);
    } catch (err) {
      throw new __WEBPACK_IMPORTED_MODULE_1__server_error__["a" /* default */]('Ошибка при создании ViewRenderer: ', 500, err);
    }
  }

  _initMiddlewares() {// мидлвара для обработки ошибок
  ...
  _initRouter() {
    const router = Object(__WEBPACK_IMPORTED_MODULE_3__routes__["default"])(this._viewRenderer, this._isProductionMode); // @TODO: allowedMethods
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models_view_renderer__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helpers_app_error__ = __webpack_require__(50);





const KoaRouter = __webpack_require__(9);
...
module.exports = function (viewRenderer, isProd) {
  const renderContent = async (ctx, context) => {
    if (!viewRenderer.renderer) {
      Object(__WEBPACK_IMPORTED_MODULE_3__helpers_app_error__["a" /* default */])(ctx, 'ViewRenderer не успел инициализироваться.');
      return;
    }
    ...
    try {
      const content = await viewRenderer.render(context); // $FlowFixMe

      ctx.body.end(content);
    } catch (err) {
      Object(__WEBPACK_IMPORTED_MODULE_3__helpers_app_error__["a" /* default */])(ctx, 'Ошибка при рендеринге контента: ', 500, err);
    }
  };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models_server_error__ = __webpack_require__(6);

/* harmony default export */ __webpack_exports__["a"] = ((ctx, message, statusCode = 500, err) => {
  ctx.app.emit('error', new __WEBPACK_IMPORTED_MODULE_0__models_server_error__["a" /* default */](message, statusCode, err), ctx);
});
